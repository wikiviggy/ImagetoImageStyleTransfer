...
input_dir = './data/toy_train' # path to folder containing images
output_dir = './chkpt' # where to put output files
seed = 100  # Some random number
mode = 'train' # choices=["train", "test", "export"]
checkpoint_def = None #'./chkpt' # directory with checkpoint to resume training from or use for testing

max_steps = 2**32 # number of training steps (0 to disable)
max_epochs = 5 # number of training epochs
summary_freq = 20 # update summaries every summary_freq steps
...
save_freq = 20 # save model every save_freq steps, 0 to disable
